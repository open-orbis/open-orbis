            ...
            {!onAdminPage && <div className="px-1 pb-1">
              ...
              <div className="mt-1 space-y-1">
                ...
                <button
                  ...
                  className="group w-full h-10 flex items-center gap-3 px-2.5 rounded-lg text-sm text-white/75 hover:bg-blue-500/10 hover:text-blue-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-400/70 transition-colors cursor-pointer"
                >
                  <svg className="w-4 h-4 text-white/45 group-hover:text-blue-300 transition-colors" fill="none" viewBox="0 0 24 24" stroke="currentColor">
