...
class Settings(BaseSettings):
    ...
    cloud_run_url: str = ""  # e.g. "https://orbis-api-390775751253.europe-west1.run.app"
    cloud_run_service_account: str = ""  # e.g. "390775751253-compute@developer.gserviceaccount.com"
